...
class Ui_authenticationsystem(object):
    def setupUi(self, authenticationsystem):
        ...
        sizePolicy.setHeightForWidth(authenticationsystem.sizePolicy().hasHeightForWidth())
        authenticationsystem.setSizePolicy(sizePolicy)
        authenticationsystem.setMinimumSize(QSize(313, 331))
        authenticationsystem.setMaximumSize(QSize(313, 331))
        authenticationsystem.setStyleSheet(u"background-color: rgb(255, 255, 255);")
...
"")
        ...
        self.login_button.setStyleSheet(u" padding: 8px 16px;  \n"
"    color: white;  \n"
...
"    border: 1px solid rgb(0, 102, 204); ")
        ...
        self.verticalLayoutWidget.setGeometry(QRect(0, 0, 291, 324))
...
"")
        ...
        self.signup_button.setStyleSheet(u" padding: 8px 16px;\n"
"    color: white;\n"
"    background-color: black; \n"
"    border-radius: 5px; \n"
"    border: 1px solid rgb(0, 102, 204);  ")
    ...
    def retranslateUi(self, authenticationsystem):
        authenticationsystem.setWindowTitle(QCoreApplication.translate("authenticationsystem", u"Authentication Form", None))
        ...
        self.createacc_button.setToolTip(QCoreApplication.translate("authenticationsystem", u"<html><head/><body><p align=\"right\"><br/></p></body></html>", None))
        ...
        self.back2login_button.setText(QCoreApplication.translate("authenticationsystem", u"Back to Login", None))

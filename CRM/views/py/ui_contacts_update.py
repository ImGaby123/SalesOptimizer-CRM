...
class Ui_contacts_update(object):
    def setupUi(self, contacts_update):
        ...
        self.gridLayout_5 = QGridLayout(contacts_update)
        ...
        self.gridLayout.addLayout(self.verticalLayout_19, 6, 0, 1, 1)
        ...
        self.gridLayout.addLayout(self.gridLayout_27, 8, 0, 1, 1)
        ...
        self.gridLayout.addLayout(self.gridLayout_8, 7, 0, 1, 1)
        ...
        self.gridLayout_17.addWidget(self.FaxLabel_4, 3, 0, 1, 1)
        ...
        self.gridLayout_17.addWidget(self.fax_line, 4, 0, 1, 1)
        ...
        self.gridLayout_17.addLayout(self.verticalLayout_8, 5, 0, 1, 1)
        ...
        self.gridLayout.addLayout(self.gridLayout_11, 9, 0, 1, 1)

...
"")
        ...
        font1.setBold(True)
        self.AdditionalInformation_16.setFont(font1)
        ...
        self.widget_21.setEnabled(False)
...
"")
        ...
        self.company_email_line.setEnabled(False)
        ...
        self.company_website_line.setEnabled(False)
        ...
        self.source_name_line.setEnabled(False)
    ...
    def retranslateUi(self, contacts_view):
        ...
        self.AdditionalInformation_14.setText(QCoreApplication.translate("contacts_view", u"Contact Address ", None))
        ...
        self.CompanyLabel_5.setText(QCoreApplication.translate("contacts_view", u"Company Email (Optional):", None))
        ...
        self.gender_combo.setPlaceholderText(QCoreApplication.translate("contacts_view", u"Select a gender", None))
        self.FirstNameLabel_5.setText(QCoreApplication.translate("contacts_view", u"*", None))
        self.FirstNameLabel_4.setText(QCoreApplication.translate("contacts_view", u"First Name :", None))
        self.FirstNameLabel_6.setText(QCoreApplication.translate("contacts_view", u"*", None))
        self.LastNameLabel_4.setText(QCoreApplication.translate("contacts_view", u"Last Name :", None))
        self.FirstNameLabel_7.setText(QCoreApplication.translate("contacts_view", u"*", None))
        self.MiddleNameLabel_8.setText(QCoreApplication.translate("contacts_view", u"Email :", None))
        self.FirstNameLabel_8.setText(QCoreApplication.translate("contacts_view", u"*", None))

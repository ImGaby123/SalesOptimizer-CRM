...
"background-color: rgb(255, 255, 255);")
        ...
        self.company_zip_line.setEnabled(False)
        ...
        self.company_state_line.setEnabled(False)
...
"")
        ...
        QWidget.setTabOrder(self.company_line, self.source_name_line)
        QWidget.setTabOrder(self.source_name_line, self.company_email_line)
    ...
    def retranslateUi(self, contacts_view):
        ...
        self.AdditionalInformation_14.setText(QCoreApplication.translate("contacts_view", u"Company Address ", None))
        self.address_type_combo.setItemText(0, QCoreApplication.translate("contacts_view", u"Billing", None))
        self.address_type_combo.setItemText(1, QCoreApplication.translate("contacts_view", u"Shipping", None))
        self.address_type_combo.setItemText(2, QCoreApplication.translate("contacts_view", u"Office", None))

        self.address_type_combo.setPlaceholderText(QCoreApplication.translate("contacts_view", u"Select Address Type", None))
        self.ZipPostalCodeLabel_7.setText(QCoreApplication.translate("contacts_view", u"Zip/Postal Code (Optional):", None))

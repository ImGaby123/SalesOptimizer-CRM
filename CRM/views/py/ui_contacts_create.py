...
"")
    ...
    def retranslateUi(self, contacts_create):
        ...
        self.gender_combo.setItemText(1, QCoreApplication.translate("contacts_create", u"Male", None))
        self.gender_combo.setItemText(2, QCoreApplication.translate("contacts_create", u"Female", None))
        self.gender_combo.setItemText(3, QCoreApplication.translate("contacts_create", u"Other", None))

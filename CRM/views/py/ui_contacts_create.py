...
class Ui_contacts_create(object):
    def setupUi(self, contacts_create):
        ...
        contacts_create.setStyleSheet(u"background-color: transparent;\n"
...
"}")
    ...
    def retranslateUi(self, contacts_create):
        ...
        self.FirstNameLabel_11.setText(QCoreApplication.translate("contacts_create", u"*", None))
        self.CompanyLabel_5.setText(QCoreApplication.translate("contacts_create", u"Company Email :", None))
        ...
        self.CompanyLabel.setText(QCoreApplication.translate("contacts_create", u"Company :", None))
        self.title_combo.setItemText(0, QCoreApplication.translate("contacts_create", u"CEO (Chief Executive Officer)", None))
        self.title_combo.setItemText(1, QCoreApplication.translate("contacts_create", u"COO (Chief Operating Officer)", None))
        self.title_combo.setItemText(2, QCoreApplication.translate("contacts_create", u"CFO (Chief Financial Officer)", None))
        self.title_combo.setItemText(3, QCoreApplication.translate("contacts_create", u"CTO (Chief Technology Officer)", None))
        self.title_combo.setItemText(4, QCoreApplication.translate("contacts_create", u"CMO (Chief Marketing Officer)", None))
        self.title_combo.setItemText(5, QCoreApplication.translate("contacts_create", u"CIO (Chief Information Officer)", None))
        self.title_combo.setItemText(6, QCoreApplication.translate("contacts_create", u"CHRO (Chief Human Resources Officer)", None))
        self.title_combo.setItemText(7, QCoreApplication.translate("contacts_create", u"Managing Director", None))
        self.title_combo.setItemText(8, QCoreApplication.translate("contacts_create", u"General Manager", None))
        self.title_combo.setItemText(9, QCoreApplication.translate("contacts_create", u"Operations Manager", None))
        self.title_combo.setItemText(10, QCoreApplication.translate("contacts_create", u"Marketing Manager", None))
        self.title_combo.setItemText(11, QCoreApplication.translate("contacts_create", u"Sales Manager", None))
        self.title_combo.setItemText(12, QCoreApplication.translate("contacts_create", u"Finance Manager", None))
        self.title_combo.setItemText(13, QCoreApplication.translate("contacts_create", u"HR Manager", None))
        self.title_combo.setItemText(14, QCoreApplication.translate("contacts_create", u"Product Manager", None))
        self.title_combo.setItemText(15, QCoreApplication.translate("contacts_create", u"IT Manager", None))
        self.title_combo.setItemText(16, QCoreApplication.translate("contacts_create", u"Software Engineer", None))
        self.title_combo.setItemText(17, QCoreApplication.translate("contacts_create", u"Sales Representative", None))
        self.title_combo.setItemText(18, QCoreApplication.translate("contacts_create", u"Marketing Specialist", None))
        self.title_combo.setItemText(19, QCoreApplication.translate("contacts_create", u"Business Analyst", None))
        self.title_combo.setItemText(20, QCoreApplication.translate("contacts_create", u"Customer Support Agent", None))
        self.title_combo.setItemText(21, QCoreApplication.translate("contacts_create", u"Accountant", None))
        self.title_combo.setItemText(22, QCoreApplication.translate("contacts_create", u"Recruiter", None))
        self.title_combo.setItemText(23, QCoreApplication.translate("contacts_create", u"Data Analyst", None))
        self.title_combo.setItemText(24, QCoreApplication.translate("contacts_create", u"Designer (UI/UX, Graphic, etc.)", None))
        self.title_combo.setItemText(25, QCoreApplication.translate("contacts_create", u"Technician", None))
        self.title_combo.setItemText(26, QCoreApplication.translate("contacts_create", u"Founder / Co-Founder", None))
        self.title_combo.setItemText(27, QCoreApplication.translate("contacts_create", u"Consultant", None))
        self.title_combo.setItemText(28, QCoreApplication.translate("contacts_create", u"Intern", None))
        self.title_combo.setItemText(29, QCoreApplication.translate("contacts_create", u"Assistant / Executive Assistant", None))

        self.title_combo.setPlaceholderText(QCoreApplication.translate("contacts_create", u"Select Title/Role", None))
        self.company_industry_combo.setItemText(0, QCoreApplication.translate("contacts_create", u"Agriculture", None))
        self.company_industry_combo.setItemText(1, QCoreApplication.translate("contacts_create", u"Automotive", None))
        self.company_industry_combo.setItemText(2, QCoreApplication.translate("contacts_create", u"Construction", None))
        self.company_industry_combo.setItemText(3, QCoreApplication.translate("contacts_create", u"Consumer Goods", None))
        self.company_industry_combo.setItemText(4, QCoreApplication.translate("contacts_create", u"Education", None))
        self.company_industry_combo.setItemText(5, QCoreApplication.translate("contacts_create", u"Energy & Utilities", None))
        self.company_industry_combo.setItemText(6, QCoreApplication.translate("contacts_create", u"Financial Services", None))
        self.company_industry_combo.setItemText(7, QCoreApplication.translate("contacts_create", u"Government", None))
        self.company_industry_combo.setItemText(8, QCoreApplication.translate("contacts_create", u"Healthcare & Life Sciences", None))
        self.company_industry_combo.setItemText(9, QCoreApplication.translate("contacts_create", u"Hospitality", None))
        self.company_industry_combo.setItemText(10, QCoreApplication.translate("contacts_create", u"Information Technology", None))
        self.company_industry_combo.setItemText(11, QCoreApplication.translate("contacts_create", u"Legal Services", None))
        self.company_industry_combo.setItemText(12, QCoreApplication.translate("contacts_create", u"Logistics & Transportation", None))
        self.company_industry_combo.setItemText(13, QCoreApplication.translate("contacts_create", u"Manufacturing", None))
        self.company_industry_combo.setItemText(14, QCoreApplication.translate("contacts_create", u"Media & Entertainment", None))
        self.company_industry_combo.setItemText(15, QCoreApplication.translate("contacts_create", u"Nonprofit", None))
        self.company_industry_combo.setItemText(16, QCoreApplication.translate("contacts_create", u"Professional Services", None))
        self.company_industry_combo.setItemText(17, QCoreApplication.translate("contacts_create", u"Real Estate", None))
        self.company_industry_combo.setItemText(18, QCoreApplication.translate("contacts_create", u"Retail & E-Commerce", None))
        self.company_industry_combo.setItemText(19, QCoreApplication.translate("contacts_create", u"Telecommunications", None))
        self.company_industry_combo.setItemText(20, QCoreApplication.translate("contacts_create", u"Travel & Tourism", None))

        self.company_industry_combo.setPlaceholderText(QCoreApplication.translate("contacts_create", u"Select an Industry", None))
        ...
        self.AdditionalInformation_14.setText(QCoreApplication.translate("contacts_create", u"Company Address ", None))
        self.address_type_combo.setItemText(0, QCoreApplication.translate("contacts_create", u"Billing", None))
        self.address_type_combo.setItemText(1, QCoreApplication.translate("contacts_create", u"Shipping", None))
        self.address_type_combo.setItemText(2, QCoreApplication.translate("contacts_create", u"Office", None))

        self.address_type_combo.setPlaceholderText(QCoreApplication.translate("contacts_create", u"Select Address Type", None))
        self.ZipPostalCodeLabel_7.setText(QCoreApplication.translate("contacts_create", u"Zip/Postal Code (Optional):", None))
        self.StreetLabel_7.setText(QCoreApplication.translate("contacts_create", u"Street (Optional):", None))
        self.ZipPostalCodeLabel_8.setText(QCoreApplication.translate("contacts_create", u"Address Type (Optional):", None))
        self.CountryLabel_7.setText(QCoreApplication.translate("contacts_create", u"Country (Optional) :", None))
        ...
        self.city_combo.setPlaceholderText(QCoreApplication.translate("contacts_create", u"Select City", None))
        self.country_combo.setPlaceholderText(QCoreApplication.translate("contacts_create", u"Select Country", None))
        self.CountryLabel_4.setText(QCoreApplication.translate("contacts_create", u"Country (Optional) :", None))
        self.CityLabel_4.setText(QCoreApplication.translate("contacts_create", u"City (Optional, Select Country First):", None))
        self.State_ProvinceLabel_4.setText(QCoreApplication.translate("contacts_create", u"State/Province (Optional):", None))
        self.AdditionalInformation_20.setText(QCoreApplication.translate("contacts_create", u"Contact Address ", None))

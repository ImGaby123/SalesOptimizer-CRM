...
"")
    ...
    def retranslateUi(self, add_campaign):
        add_campaign.setWindowTitle(QCoreApplication.translate("add_campaign", u"edit_campaign", None))
        ...
        self.save_btn.setText(QCoreApplication.translate("add_campaign", u"Save", None))

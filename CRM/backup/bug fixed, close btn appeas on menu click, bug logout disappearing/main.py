...
class MainWindow(QMainWindow):
    ...
    def open_left_subwindow(self):
        """ Open the left subwindow with its contents and ensure close button remains. """
        if self.left_subwin:  # Remove existing subwindow if it exists
            self.left_subwin.close()
            self.mdi_area.removeSubWindow(self.left_subwin)
        ...
        self.left_subwin.setWindowFlags(Qt.Window | Qt.WindowTitleHint | Qt.WindowCloseButtonHint)
        self.left_subwin.resize(int(self.width() * 0.1), self.height())
        self.mdi_area.addSubWindow(self.left_subwin)
        self.left_subwin.show()

    def open_right_subwindow(self):
        """ Open the right subwindow with the Contacts UI and ensure close button remains. """
        if self.right_subwin:  # Remove existing subwindow if it exists
            self.right_subwin.close()
            self.mdi_area.removeSubWindow(self.right_subwin)
        ...
        self.right_subwin.setWindowFlags(Qt.Window | Qt.WindowTitleHint | Qt.WindowCloseButtonHint)
        self.right_subwin.resize(int(self.width() * 0.9), self.height())

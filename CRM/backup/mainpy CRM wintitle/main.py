...
class MainWindow(QMainWindow):
    ...
    def create_subwindows(self):
        ...
        """ Create two frameless subwindows with a 10:90 split inside the MDI area. """
        ...
        self.left_subwin.setWindowFlags(Qt.FramelessWindowHint)  # Make frameless
        ...
        self.right_subwin.setWindowFlags(Qt.FramelessWindowHint)  # Make frameless

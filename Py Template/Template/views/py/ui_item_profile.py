...
################################################################################
## Form generated from reading UI file 'item_profile.ui'
##
...
class Ui_item_profile(object):
    def setupUi(self, item_profile):
        if not item_profile.objectName():
            item_profile.setObjectName(u"item_profile")
        item_profile.resize(1135, 603)
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(item_profile.sizePolicy().hasHeightForWidth())
        item_profile.setSizePolicy(sizePolicy)
        item_profile.setStyleSheet(u"background-color: transparent;\n"
"background-color: rgb(255, 255, 255);\n"
"")
        self.gridLayout_11 = QGridLayout(item_profile)
        self.gridLayout_11.setObjectName(u"gridLayout_11")
        self.scrollArea_4 = QScrollArea(item_profile)
...
"}")
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QRect(0, 0, 1115, 583))
...
"")
        ...
        sizePolicy3.setHeightForWidth(self.FirstNameLabel_8.sizePolicy().hasHeightForWidth())
        self.FirstNameLabel_8.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.FirstNameLabel_5.sizePolicy().hasHeightForWidth())
        self.FirstNameLabel_5.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.FirstNameLabel_7.sizePolicy().hasHeightForWidth())
        self.FirstNameLabel_7.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.FirstNameLabel_6.sizePolicy().hasHeightForWidth())
        self.FirstNameLabel_6.setSizePolicy(sizePolicy3)
        ...
        self.horizontalSpacer = QSpacerItem(90, 20, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)
        ...
        sizePolicy3.setHeightForWidth(self.FirstNameLabel_9.sizePolicy().hasHeightForWidth())
        self.FirstNameLabel_9.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.FirstNameLabel_11.sizePolicy().hasHeightForWidth())
        self.FirstNameLabel_11.setSizePolicy(sizePolicy3)
        ...
        self.horizontalSpacer_5 = QSpacerItem(40, 20, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)
...
"}")
        ...
        self.gridLayout.addLayout(self.gridLayout_14, 10, 1, 1, 1)
        ...
        QWidget.setTabOrder(self.company_industry_line, self.scrollArea_4)

        self.retranslateUi(item_profile)

        self.gender_combo.setCurrentIndex(-1)


        QMetaObject.connectSlotsByName(item_profile)
    # setupUi

    def retranslateUi(self, item_profile):
        item_profile.setWindowTitle(QCoreApplication.translate("item_profile", u"Add Contact", None))
        self.back_btn.setText(QCoreApplication.translate("item_profile", u"< Back to Items", None))
        self.gender_combo.setItemText(0, QCoreApplication.translate("item_profile", u"Male", None))
        self.gender_combo.setItemText(1, QCoreApplication.translate("item_profile", u"Female", None))
        self.gender_combo.setItemText(2, QCoreApplication.translate("item_profile", u"Other", None))

        self.gender_combo.setPlaceholderText(QCoreApplication.translate("item_profile", u"Select a gender", None))
        self.FirstNameLabel_8.setText(QCoreApplication.translate("item_profile", u"*", None))
        self.SuffixLabel_8.setText(QCoreApplication.translate("item_profile", u"Phone Number :", None))
        self.FirstNameLabel_5.setText(QCoreApplication.translate("item_profile", u"*", None))
        self.FirstNameLabel_4.setText(QCoreApplication.translate("item_profile", u"First Name :", None))
        self.FirstNameLabel_7.setText(QCoreApplication.translate("item_profile", u"*", None))
        self.MiddleNameLabel_8.setText(QCoreApplication.translate("item_profile", u"Email :", None))
        self.GenderLabel_4.setText(QCoreApplication.translate("item_profile", u"Gender (Optional):", None))
        self.FirstNameLabel_6.setText(QCoreApplication.translate("item_profile", u"*", None))
        self.LastNameLabel_4.setText(QCoreApplication.translate("item_profile", u"Last Name :", None))
        self.CompanyLabel_6.setText(QCoreApplication.translate("item_profile", u"Company Website (Optional):", None))
        self.FirstNameLabel_9.setText(QCoreApplication.translate("item_profile", u"*", None))
        self.CompanyLabel.setText(QCoreApplication.translate("item_profile", u"Company :", None))
        self.CompanyLabel_7.setText(QCoreApplication.translate("item_profile", u"Industry (Optional):", None))
        self.FirstNameLabel_11.setText(QCoreApplication.translate("item_profile", u"*", None))
        self.CompanyLabel_5.setText(QCoreApplication.translate("item_profile", u"Company Email :", None))
        self.AdditionalInformation_15.setText(QCoreApplication.translate("item_profile", u"Item Information", None))
    # retranslateUi

...
################################################################################
## Form generated from reading UI file 'item_table_view.ui'
##
...
class Ui_item_table_view(object):
    def setupUi(self, item_table_view):
        if not item_table_view.objectName():
            item_table_view.setObjectName(u"item_table_view")
        item_table_view.resize(1201, 680)
        item_table_view.setStyleSheet(u"")
        self.gridLayout_3 = QGridLayout(item_table_view)
        ...
        self.items_tbl = QTableWidget(item_table_view)
        self.items_tbl.setObjectName(u"items_tbl")
        self.items_tbl.setMouseTracking(False)
        self.items_tbl.setStyleSheet(u"QTableWidget {\n"
...
"")
        ...
        self.items_tbl.horizontalHeader().setCascadingSectionResizes(False)
        self.items_tbl.horizontalHeader().setDefaultSectionSize(200)
        self.items_tbl.horizontalHeader().setStretchLastSection(True)

        self.gridLayout.addWidget(self.items_tbl, 10, 0, 1, 1)
        ...
        self.sort_combo = QComboBox(item_table_view)
...
"")
        ...
        self.selecteditems_lbl = QLabel(item_table_view)
        ...
        self.selecteditems_lbl.setStyleSheet(u"color: rgb(0, 0, 0)\n"
"")
        self.selecteditems_lbl.setAlignment(Qt.AlignCenter)
        ...
        self.search_line = QLineEdit(item_table_view)
...
"}")
        ...
        self.search_line.setCursorMoveStyle(Qt.LogicalMoveStyle)
        ...
        self.add_btn = QPushButton(item_table_view)
...
"}")
        ...
        self.delete_btn = QPushButton(item_table_view)
...
"}")
        ...
        self.contacts_txt = QLabel(item_table_view)
...
"color: rgb(0, 0, 0);")
        ...
        self.retranslateUi(item_table_view)

        QMetaObject.connectSlotsByName(item_table_view)
    # setupUi

    def retranslateUi(self, item_table_view):
        item_table_view.setWindowTitle(QCoreApplication.translate("item_table_view", u"Contacts", None))
        self.sort_combo.setItemText(0, QCoreApplication.translate("item_table_view", u"Recently Added", None))
        self.sort_combo.setItemText(1, QCoreApplication.translate("item_table_view", u"Oldest", None))
        self.sort_combo.setItemText(2, QCoreApplication.translate("item_table_view", u"Alphabetical", None))

        self.sort_combo.setPlaceholderText(QCoreApplication.translate("item_table_view", u"All Item", None))
        self.selecteditems_lbl.setText(QCoreApplication.translate("item_table_view", u"TextLabel", None))
        self.search_line.setPlaceholderText(QCoreApplication.translate("item_table_view", u"Search Item", None))
#if QT_CONFIG(tooltip)
        self.add_btn.setToolTip(QCoreApplication.translate("item_table_view", u"Add Contact", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.add_btn.setWhatsThis(QCoreApplication.translate("item_table_view", u"add contact", None))
#endif // QT_CONFIG(whatsthis)
        self.add_btn.setText(QCoreApplication.translate("item_table_view", u"Add", None))
#if QT_CONFIG(tooltip)
        self.delete_btn.setToolTip(QCoreApplication.translate("item_table_view", u"Delete Contacts", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.delete_btn.setWhatsThis(QCoreApplication.translate("item_table_view", u"delete contact", None))
#endif // QT_CONFIG(whatsthis)
        self.delete_btn.setText(QCoreApplication.translate("item_table_view", u"Del", None))
        self.contacts_txt.setText(QCoreApplication.translate("item_table_view", u"Item", None))
    # retranslateUi
